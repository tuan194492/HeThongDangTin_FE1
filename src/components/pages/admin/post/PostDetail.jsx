...
import { getPostById, deletePostById } from "../../../../api/owner/post";
      ...
      <div className="flex">
        ...
        </h2>
        {
            postData && postData.status == 'O' && 
                <button
                    className="ml-[240px] px-3 py-2 text-white bg-red-500 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-opacity-50 text-xl"

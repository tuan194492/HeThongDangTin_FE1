...
const baseServerLocation = `${process.env.REACT_APP_BE_HOST}`;
...
export const PostDetail = () => {
    ...
    const getPostImagesByImagesUrl = (imageUrls) => {
        ...
        const reducedArray = urls.reduce((acc, value) => {
    ...
    const fetchPostDataById = async () => {
        ...
        if (result.success) {
            ...
            const images = getPostImagesByImagesUrl(result.data.images_urls);
